...
import { Sprout, Factory, ShoppingCart, ChevronDown, CheckCircle2 } from 'lucide-react';
...
const steps = [
      ...
      <div className="space-y-4">
        ...
        <ul className="space-y-3">
          <li className="flex items-start gap-3 text-sm text-gray-600">
            ...
            <span>
              <strong>Capacitación en Inocuidad:</strong> Implementación rigurosa de buenas prácticas agricolas.
            </span>
          </li>
          <li className="flex items-start gap-3 text-sm text-gray-600">
            <CheckCircle2 size={18} className="text-[#1da44c] mt-0.5 shrink-0" />
          ...
          <li className="flex items-start gap-3 text-sm text-gray-600">
            <CheckCircle2 size={18} className="text-[#1da44c] mt-0.5 shrink-0" />
            <span>
              <strong>Control Especializado:</strong> Asesoría puntual en control de plagas, detección temprana de enfermedades, nutrición vegetal balanceada y uso responsable de agroquímicos autorizados.
            </span>
          </li>
        </ul>
      </div>
  ...
  {
    id: 2,
    title: "Hervasa Berries",
    role: "Logística y Procesamiento",
    summary: "Somos el filtro de calidad y el motor logístico. Dando seguimiento a la producción, recepcion, conservación y envio de nuestro producto.",
...
const ProcessSteps = () => {
  // Estado para saber cuál tarjeta está abierta (null = ninguna)
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
      {steps.map((step) => (
        ...
        >
          ...
          <div className="p-8">
            <div className={`w-16 h-16 rounded-2xl flex items-center justify-center mb-6 text-white shadow-lg transition-colors duration-300 ${
              activeStep === step.id ? 'bg-[#1da44c]' : 'bg-gray-900'
            }`}>
              {step.icon}
            </div>
